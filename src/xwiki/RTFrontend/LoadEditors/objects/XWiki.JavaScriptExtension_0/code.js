define(['jquery', 'xwiki-meta'], function($, xm) {
    ...
    var MESSAGES = module.messages = {
        ...
        rejectDialog_invalid: "The editing mode currently used by the other user doesn't allow collaborative editing. Your request has been automatically rejected. Please wait for the document to be unlocked.",
        rejectDialog_OK: 'OK',
    ...
    if (document.documentElement.lang==="fr") {
      MESSAGES = module.messages = {
        ...
        rejectDialog_invalid: "Le mode d'édition utilisé actuellement pas l'autre éditeur ne permet pas l'édition collaborative. Votre demande a été refusée automatiquement. Veuillez attendre que le document soit déverrouillé.",
        rejectDialog_OK: 'OK',
